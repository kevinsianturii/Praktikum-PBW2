...
class CollectionsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function (Collections $collection) {
            ...
            ->addColumn('jenisKoleksi', function (Collections $collection) {
     ...
     */
    public function query(Collections $model): QueryBuilder
    {
